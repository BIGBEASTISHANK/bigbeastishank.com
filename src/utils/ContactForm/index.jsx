  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mt-3 p-4 rounded-lg border border-black/20 transition-all bg-gray-900/70 backdrop-blur-md w-full">
        ...
        <ValidationError
          className="mt-1 ml-[4.2rem] text-red-700"
          prefix="Name"
          field="name"
          errors={state.errors}
        />
      ...
      <div className="flex flex-col mt-3 p-4 rounded-lg border border-black/20 transition-all bg-gray-900/70 backdrop-blur-md w-full">
        <div className="flex my-auto">
          <label
            for="Subject"
            className="w-[4.5rem] pr-2 select-none font-black"
          >
            Subject:
          </label>
          <input
      ...
      <button
        type="submit"
        className="group mt-3 ml-2 flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-white/10 text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-white/20 active:scale-105 disabled:scale-100"
