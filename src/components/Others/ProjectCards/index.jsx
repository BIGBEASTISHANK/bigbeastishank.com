    ...
    <div className="my-auto projectW:flex projectW:flex-wrap gap-[2rem] justify-center items-center">
      {projectData.map((data, index) => (
        ...
        <motion.div
          ...
          custom={index}
        >
          <div className="bg-gray-800/70 backdrop-blur-xl p-5 rounded-2xl transition-all 2xl:max-w-[26.85rem] projectW:max-w-[22.05rem] projectW:mb-0 mb-8 drop-shadow-3xl hover:drop-shadow-blueGlow hover:bg-gray-900/85 hover:scale-[1.05] group/card">
            {/* Image */}
            <Image
              src={data.imageUrl}
              alt={data.title}
