...
export default function Navbar() {
  ...
  return (
    <nav className=" fixed top-0 left-0 right-0 flex justify-center items-center my-10 z-50">
      <div className="border border-neutral-800 bg-black/10 backdrop-blur-sm rounded-full p-1">
        <ul className="flex md:gap-2 gap-1">
          {navLinks.map((data, index) => (
            <li
              ...
              } rounded-full md:py-[0.375rem] md:px-5 py-1 px-3 md:text-base text-sm transition-all`}
            >
