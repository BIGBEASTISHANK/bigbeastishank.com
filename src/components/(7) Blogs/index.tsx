                ...
                description={
                    <>
                        <p>
                            ...
                            Flutter, machine learning experiments, and the
                            occasional deep dive into game development. Each
                            post reflects real-world challenges I've tackled and
                            the solutions I've discovered along the way. Looking
                            for content on a particular technology or facing a
                            specific development challenge? Drop me a line using
                            ...
                            - I'm always open to exploring new topics that could
        ...
        <>
            ...
            >
                ...
                <input
                    ...
                    onChange={(e) => {
                        setCardAnimationDelay(0.15);
                        setPageBtnAnimationDelay(
                            0.3 + (postsPerPage * 0.3) / 2
                        );
