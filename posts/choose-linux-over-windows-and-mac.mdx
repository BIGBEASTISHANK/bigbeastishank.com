  ...
  <table className="w-full min-w-[600px] border-separate border-spacing-0 text-[#F6F9FC] font-sans rounded-lg overflow-hidden">
    <thead>
      <tr className="bg-[#1A1E23]">
        <th className="md:w-48 w-32 border border-[#1793D1] p-3 text-left font-bold whitespace-nowrap rounded-tl-lg">
          Feature
        </th>
        <th className="md:w-48 w-32 border-t border-b border-r border-[#1793D1] p-3 text-left whitespace-nowrap">
          Linux
        </th>
        <th className="md:w-48 w-32 border-t border-b border-r border-[#1793D1] p-3 text-left whitespace-nowrap">
          Windows
        </th>
        <th className="md:w-48 w-32 border-t border-b border-r border-[#1793D1] p-3 text-left whitespace-nowrap rounded-tr-lg">
          macOS
        </th>
      </tr>
    </thead>
    <tbody>
      {[
        ...
        >
          <td
            className={`md:w-48 w-32 border-l border-b border-r border-[#1793D1] p-3 whitespace-nowrap
              ${i === 6 ? "rounded-bl-lg" : ""}
            `}
          >
            {row[0]}
          ...
          {row.slice(1).map((cell, j) => (
            <td
              key={j}
              className={`md:w-48 w-32 border-b border-r border-[#1793D1] p-3 ${
                i === 6 && j === 2 ? "rounded-br-lg" : ""
              }`}
            >
              {cell}
            </td>
